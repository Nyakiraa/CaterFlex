      ...
      <div className="space-y-8">
        ...
        <div className="border-b border-border">
          <div className="flex gap-8">
            <button type="button" onClick={() => setActiveTab('dishes')} className={`py-4 text-sm font-medium transition-colors ${activeTab === 'dishes' ? 'border-b-2 border-primary text-card-foreground' : 'text-muted-foreground hover:text-foreground'}`}>Dishes</button>
